Translations: [English (en)](README.md) · [日本語 (ja)](README.ja.md) · [한국어 (ko)](README.ko.md) · [Português (br)](README.pt_BR.md)

HTML Best Practices
===================

Para escrever documentos HTML escaláveis e reaproveitáveis

<!-- #toc -->

- [Geral](#geral)
    - [Inicie com DOCTYPE](#inicie-com-doctype)
    - [Não use DOCTYPE legado ou obsoleto](#nao-use-doctype-legado-ou-obsoleto)
    - [Não use Declaração XML](#nao-use-declaracao-xml)
    - [Evite usar referências de caracteres o máximo possível](#evite-usar-referencias-de-caracteres-o-maximo-possivel)
    - [Escape `&`, `<`, `>`, `"`, e `'`  com referências de caracteres nomeadas](#escape-----e--com-referencias-de-caracteres-nomeadas)
    - [Use referências de caracteres numéricos para controlar ou ocultar caracteres](#use-referencias-de-caracteres-numericos-para-controlar-ou-ocultar-caracteres)
    - [Coloque espaços em branco ao redor do conteúdo do comentário](#coloque-espacos-em-branco-ao-redor-do-conteudo-do-comentario)
    - [Não omita a tag de fechamento](#nao-omita-a-tag-de-fechamento)
    - [Não misture o formato de elemento vazio](#nao-misture-o-formato-de-elemento-vazio)
    - [Não coloque espaços em branco ao redor de tags e valores de atributo](#nao-coloque-espacos-em-branco-ao-redor-de-tags-e-valores-de-atributo)
    - [Não misture caracteres maiúsculos e minúsculos](#nao-misture-caracteres-maiusculos-e-minusculos)
    - [Não misture aspas](#nao-misture-aspas)
    - [Não separe os atributos com dois ou mais espaços em branco](#nao-separe-os-atributos-com-dois-ou-mais-espacos-em-branco)
    - [Omita o valor do atributo boleano](#omita-o-valor-do-atributo-boleano)
    - [Omita namespaces](#omita-namespaces)
    - [Não use atributos XML](#nao-use-atributos-xml)
    - [Não misture os atributos `data-*`, Microdata, e RDFa Lite com atributos comuns](#nao-misture-os-atributos-data--microdata-e-rdfa-lite-com-atributos-comuns)
    - [Prefira semântica ARIA implícita](#prefira-semantica-aria-implicita)
